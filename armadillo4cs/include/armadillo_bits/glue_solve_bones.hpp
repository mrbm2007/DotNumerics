...
namespace solve_opts
  ...
  static constexpr uword flag_fast         = uword(1u <<  0);//1
  static constexpr uword flag_equilibrate  = uword(1u <<  1);//2
  static constexpr uword flag_no_approx    = uword(1u <<  2);//4
  static constexpr uword flag_triu         = uword(1u <<  3);//8
