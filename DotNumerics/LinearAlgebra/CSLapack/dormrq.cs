...
namespace DotNumerics.LinearAlgebra.CSLapack
{
    ...
    public class DORMRQ
    {
        ...
        public DORMRQ(LSAME lsame, ILAENV ilaenv, DLARFB dlarfb, DLARFT dlarft, DORMR2 dormr2, XERBLA xerbla)
        {
            ...
            this._lsame = lsame; this._ilaenv = ilaenv; this._dlarfb = dlarfb; this._dlarft = dlarft; this._dormr2 = dormr2; 
            this._xerbla = xerbla;
                         ...
                         , ref int INFO)
        {
            ...
            int I1 = 0;int I2 = 0; int I3 = 0; int IB = 0; int IINFO = 0; int IWS = 0; int LDWORK = 0; int LWKOPT = 0; int MI = 0; 
            int NB = 0;int NBMIN = 0; int NI = 0; int NQ = 0; int NW = 0; int offset_t = 0;
            ...
            if (NB < NBMIN || NB >= K)
            {
                ...
                // *        Use unblocked code
                // *
                this._dormr2.Run(SIDE, TRANS, M, N, K, ref A, offset_a
            ...
            else
            {
                ...
                for (I = I1; (I3 >= 0) ? (I <= I2) : (I >= I2); I += I3)
                {
                    ...
                    // *
                    this._dlarft.Run("Backward", "Rowwise", NQ - K + I + IB - 1, IB, ref A, I+1 * LDA + o_a, LDA
                    ...
                    // *           Apply H or H'
                    // *
                    this._dlarfb.Run(SIDE, TRANST, "Backward", "Rowwise", MI, NI
