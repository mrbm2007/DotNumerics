...
namespace DotNumerics.LinearAlgebra.CSLapack
{
    ...
    public class DORMLQ
    {
                         ...
                         , ref int INFO)
        {
            ...
            int I1 = 0;int I2 = 0; int I3 = 0; int IB = 0; int IC = 0; int IINFO = 0; int IWS = 0; int JC = 0; int LDWORK = 0; 
            int LWKOPT = 0;int MI = 0; int NB = 0; int NBMIN = 0; int NI = 0; int NQ = 0; int NW = 0; 
            int offset_t = 0;
            ...
            if (INFO == 0)
            {
                ...
                // *
                NB = Math.Min(NBMAX, this._ilaenv.Run(1, "DORMLQ", SIDE + TRANS, M, N, K,  - 1));
            ...
            if (NB > 1 && NB < K)
            {
                ...
                {
                    NB = LWORK / LDWORK;
                    NBMIN = Math.Max(2, this._ilaenv.Run(2, "DORMLQ", SIDE + TRANS, M, N, K,  - 1));
                }
            }
            else
            {
            ...
            if (NB < NBMIN || NB >= K)
            {
                ...
                // *        Use unblocked code
                // *
                this._dorml2.Run(SIDE, TRANS, M, N, K, ref A, offset_a
            ...
            else
            {
                ...
                for (I = I1; (I3 >= 0) ? (I <= I2) : (I >= I2); I += I3)
                {
                    ...
                    // *
                    this._dlarft.Run("Forward", "Rowwise", NQ - I + 1, IB, ref A, I+I * LDA + o_a, LDA
                    ...
                    // *           Apply H or H'
                    // *
                    this._dlarfb.Run(SIDE, TRANST, "Forward", "Rowwise", MI, NI
