...
namespace DotNumerics
{
    ...
    public struct Complex : IFormattable
    {
        ...
        {
            return new Complex(z1 + z2._real, z2._imaginary);
        }
        ...
        {
            return new Complex(z1._real + z2, z1._imaginary);
        }
        ...
        {
            var r = _real.ToString(format);
            var i = _imaginary.ToString(format);
            if (_imaginary == 0 || i == "0")
                return r;
            else if (_real == 0 || r == "0")
                return i + "i";
        ...
        public string ToString(string real, string imag)
        {
            var r = Real.ToString(real);
            var i = Imaginary.ToString(imag);
